# Reindent Lines in Code
# Reformat Code in Code 
...
# ---------------------------------------
setwd("F:/ade/Desktop/USU Masters Work/Final MS Work/Monthly Taxi Data/Raw Data")
...
# Unable to gather the header when I skipped lines using fread, therefore, I used the rename statement in tidyverse to 
# rename the columns. 
...
# Comment why I didn't "pipe" consistently and why I used the "old-fashioned)
# With how large the datasets are, when trying to pipe, the RAM space on my computer wasn't large enough and would crash after
# trying to pipe for > 15 minutes. Therefore, to obtain the data needed for my research, I used the "old-fashioned" way 
# of coding and re-structuring the data. 



# --------------------------------------
# Set Working Directory for Saved Data
# --------------------------------------
setwd("F:/ade/Desktop/USU Masters Work/Final MS Work/Monthly Taxi Data/Cleaned Data")
...
# --------------------------------------
# Load Data to Clean More - January
# --------------------------------------
...
# --------------------------------------
# Load Data to Clean More - February
# --------------------------------------
...
# --------------------------------------
# Load Data to Clean More - August
# --------------------------------------
...
# --------------------------------------
# Load Data to Clean More - September
# --------------------------------------
...
# --------------------------------------
# Load Data to Clean More - October
# --------------------------------------
...
# --------------------------------------
# Load Data to Clean More - November
# --------------------------------------
...
# --------------------------------------
# Load Data to Clean More - December
# --------------------------------------
...
# ---------------------------------------------------
# Set Working Directory for Saved Data
# This data subsets missing or invalid data points
# ---------------------------------------------------
setwd("F:/ade/Desktop/USU Masters Work/Final MS Work/Monthly Taxi Data/Cleaned Data 2")
